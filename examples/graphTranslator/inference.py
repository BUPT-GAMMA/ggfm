...
def parse_args():
    ...
    parser.add_argument('--llm_checkpoint', type=str, default="./ggfm/models/chatglm2-6b", required=False)
...
def read_arxiv_dataset():
    ...
    node2paperid = {}
    paperid2node = {}
    with open('/home/ubuntu/workspace/graphtranslator/GraphTranslator/data/arxiv/arxiv_nodeidx2paperid.csv', 'r') as file:
    ...
    paperId2titleAndabs = pd.read_csv("/home/ubuntu/workspace/graphtranslator/GraphTranslator/data/arxiv/titleabs.tsv", delimiter='\t', header=None)
    ...
    sample_neighbor_df = pd.read_csv("/home/ubuntu/workspace/graphtranslator/GraphTranslator/data/arxiv/sample_neighbor_df.csv")
...
class LLM(nn.Module):
    ...
    def inference_chatglm_arxiv(self, arxiv_data, sample_neighbor_df):
        ...
        summary_embeddings.to_csv('./ggfm/data/arxiv/summary_embeddings.csv',index=False)
