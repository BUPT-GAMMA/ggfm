...
from ggfm.models.base_model import all_gather_with_grad, concat_all_gather
from ggfm.models.translator_model.translator import (
    TranslatorBase,
    compute_sim_matrix
)
from ggfm.models.translator_model.translator_outputs import TranslatorOutput, TranslatorOutputFeatures

from transformers import BertTokenizer
from ggfm.models.translator_model.Qformer import BertConfig, BertLMHeadModel


class TranslatorQformer(TranslatorBase):
    ...
    def init_tokenizer(cls):
        tokenizer = BertTokenizer.from_pretrained("/home/cwx/workspace/ggfm/ggfm/models/bert-base-uncased")
        tokenizer.add_special_tokens({"bos_token": "[DEC]"})
        return tokenizer

    def init_Qformer(cls, num_query_token, vision_width, cross_attention_freq=2):
        encoder_config = BertConfig.from_pretrained("/home/cwx/workspace/ggfm/ggfm/models/bert-base-uncased")
        ...
        checkpoint = torch.load("/home/cwx/workspace/ggfm/ggfm/models/bert-base-uncased/model.pth", map_location=lambda storage, loc: storage)
